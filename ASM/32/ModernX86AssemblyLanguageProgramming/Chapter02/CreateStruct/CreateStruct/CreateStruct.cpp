// CreateStruct.cpp : Defines the entry point for the console application.
//
...
TestStruct* CreateTestStruct_(__int8 val8, __int16 val16, __int32 val32, __int64 val64)
{
	return nullptr;
}
